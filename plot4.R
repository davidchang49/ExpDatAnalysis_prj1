...
#getting values from variable Global_reactive_power and converting chars to numeric value
Global_reactive_power <- as.numeric(subSetData$Global_reactive_power)
#getting values from variable Voltage and converting chars to numeric value
